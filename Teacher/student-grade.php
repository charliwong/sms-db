...
if (isset($_SESSION['teacher_id']) && 
    ...
    if ($_SESSION['role'] == 'Teacher') {
       ...
       if (isset($_POST['ssubject_id'])) {
           ...
           $student_score = getScoreByStudentTeacherSubject(
               $student_id,
               $teacher_id,
               $ssubject_id,
               $setting['current_semester'],
        ...
        <form method="post"
            ...
            <div class="mb-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item"><b>Nama Depan: </b> <?php echo $student['fname'] ?></li>
                  <li class="list-group-item"><b>Nama Belakang: </b> <?php echo $student['lname'] ?></li>
                  <li class="list-group-item"><b>Nilai: </b> 
            ...
            <h5 class="text-center">Tambah Nilai</h5>
...
foreach ($subjects as $subject) {
    if (in_array($subject['subject_id'], $teacher_subjects)) {
?>
    <option value="<?=$subject['subject_id']?>"
        <?=($ssubject_id == $subject['subject_id']) ? 'selected' : '' ?>>
